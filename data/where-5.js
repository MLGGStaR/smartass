window.GAME.where.push(
  ...
  { a:"Rio de Janeiro", init:"R.D.J.", clues:[
    "I am a city.",
  ...
  { a:"Moscow", init:"M.", clues:[
    "I am a city.",
    "I am in Eastern Europe.",
    "I endure long, snowy winters.",
    "I am the largest city on my continent.",
    "A fortress called the Kremlin sits at my center.",
    "Colorful onion-domed cathedrals rise in my main square.",
    "My main plaza is known as Red Square.",
    "I am the capital of Russia."
  ]},
  { a:"Paris", init:"P.", clues:[
    "I am a city.",
    "I am in Western Europe.",
    "I am famous for fashion, cafes, and romance.",
    "I am nicknamed the City of Light.",
    "A river called the Seine flows through me.",
    "A grand museum called the Louvre holds the Mona Lisa within me.",
    "A famous iron tower rises over my skyline.",
  ...
  { a:"Sydney", init:"S.", clues:[
    "I am a city.",
    "I am in Oceania.",
    "I sit on a beautiful natural harbour.",
    "I light my harbour with fireworks each New Year.",
    "Surfers ride the waves at my Bondi Beach.",
    "A great steel arch bridge crosses my waters.",
    "An opera house with sail-shaped roofs stands on my shore.",
    "I am the largest city in Australia."
  ]},
  { a:"Athens", init:"A.", clues:[
    "I am a city.",
  ...
  { a:"Berlin", init:"B.", clues:[
    "I am a city.",
    "I am in Central Europe.",
    "I am known for vibrant art and nightlife.",
    "A river called the Spree flows through me.",
    "A wall once divided me into east and west.",
    "Pieces of my old wall are now covered in murals.",
    "A famous gate called the Brandenburg stands within me.",
    "I am the capital of Germany."
  ]},
  { a:"Madrid", init:"M.", clues:[
    "I am a city.",
    "I am on the Iberian Peninsula.",
    "I sit high on a plateau in the center of my country.",
    "I am famous for flamenco and tapas.",
    "Crowds gather in my central plaza, Puerta del Sol.",
    "A grand royal palace stands within me.",
    "My football club is one of the most famous in the world.",
    "I am the capital of Spain."
  ]},
  { a:"Bangkok", init:"B.", clues:[
    "I am a city.",
  ...
  { a:"Singapore", init:"S.", clues:[
    "I am a city.",
    "I am in Southeast Asia.",
    "I sit on an island near the equator.",
    "I am both a city and an entire country.",
    "I am spotless, modern, and full of skyscrapers.",
    "A hotel with a boat-shaped pool tops my skyline.",
    "Supertrees glow in my Gardens by the Bay.",
    "A lion-fish statue called the Merlion spouts water on my shore."
  ]},
  { a:"Mumbai", init:"M.", clues:[
    "I am a city.",
    "I am in South Asia.",
    "I am one of the most populous cities on Earth.",
  ...
  { a:"Seoul", init:"S.", clues:[
    "I am a city.",
    "I am in East Asia.",
    "A river called the Han flows through me.",
    "Ancient palaces sit beside towering skyscrapers in me.",
    "I sit just south of a heavily guarded border.",
    "I am the birthplace of K-pop and global pop hits.",
    "A song about my Gangnam district swept the world in 2012.",
    "I am the capital of South Korea."
  ]},
  { a:"Mexico City", init:"M.C.", clues:[
    "I am a city.",
    "I am in North America.",
    "I am one of the most populous cities on Earth.",
  ...
  { a:"Vienna", init:"V.", clues:[
    "I am a city.",
    "I am in Central Europe.",
    "I am often ranked the most livable city on Earth.",
    "A river called the Danube flows through me.",
    "I am famous for grand balls and waltzes.",
    "Lavish imperial palaces fill my center.",
    "Composers like Mozart and Beethoven worked within me.",
    "I am the capital of Austria."
  ]},
  { a:"Lisbon", init:"L.", clues:[
    "I am a city.",
    "I am in Western Europe.",
  ...
  { a:"Hong Kong", init:"H.K.", clues:[
    "I am a city.",
    "I am in East Asia.",
    "I have one of the most dramatic skylines on Earth.",
    "Skyscrapers crowd my harbour and rise up steep hills.",
    "A nightly light show dazzles over my waters.",
    "Star Ferries cross my busy Victoria Harbour.",
    "I was a British colony until 1997.",
    "I am now a special region of China."
  ]},
  { a:"Marrakech", init:"M.", clues:[
    "I am a city.",
  ...
  { a:"Jerusalem", init:"J.", clues:[
    ...
    "I am one of the oldest cities in the world.",
    "Stone walls surround my historic heart.",
    "I am sacred to three major religions.",
    "Worshippers pray at my ancient Western Wall.",
    "A golden Dome of the Rock shines over my old city.",
    "I am a holy city claimed by Israelis and Palestinians."
  ]},
  { a:"Havana", init:"H.", clues:[
    "I am a city.",
  ...
  { a:"Reykjavik", init:"R.", clues:[
    "I am a city.",
    "I am in Northern Europe.",
    "I am the northernmost capital of a sovereign nation.",
    "I sit on an island of fire and ice.",
    "Hot springs and geysers bubble near me.",
    "The Northern Lights often dance above me.",
    "A steaming Blue Lagoon lies not far from me.",
    "I am the capital of Iceland."
  ]},
  { a:"Venice Beach", init:"V.B.", clues:[
    "I am a place.",
    "I am in North America.",
  ...
  { a:"Lagos", init:"L.", clues:[
    "I am a city.",
    "I am in West Africa.",
    "I am one of the most populous cities on my continent.",
    "I sit on the coast of the Atlantic Ocean.",
    "I sprawl across islands and a busy mainland.",
    "I am the home of Afrobeats music.",
    "I was once my nation's capital before it moved inland.",
    "I am the largest city in Nigeria."
  ]},
  { a:"Petronas", init:"P.", clues:[
    "I am a place known for my towers.",
    "I am in Southeast Asia.",
  ...
  { a:"Amman", init:"A.", clues:[
    "I am a city.",
    "I am in the Middle East.",
    "I am one of the oldest continuously lived-in cities on Earth.",
    "I am built across many rolling hills.",
    "A Roman theatre is carved into my hillside.",
    "An ancient citadel crowns one of my hilltops.",
    "The rose-red ruins of Petra lie to my south.",
    "I am the capital of Jordan."
  ]},
  { a:"Dakar", init:"D.", clues:[
    "I am a city.",
    "I am in West Africa.",
  ...
  { a:"Helsinki", init:"H.", clues:[
    "I am a city.",
    "I am in Northern Europe.",
    "I sit on the shore of the Baltic Sea.",
    "I endure long, dark winters and bright summer nights.",
    "I am known for clean design and saunas.",
    "A white domed cathedral overlooks my harbour.",
    "Ferries connect me to nearby Estonia and Sweden.",
    "I am the capital of Finland."
  ]}
);
