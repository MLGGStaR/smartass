window.GAME.who.push(
  { a:"Tupac Shakur", init:"T.S.", clues:[
    "I am a real person.",
    "I rose to fame in the 1990s.",
    "I am an American hip-hop artist.",
    "I was also an actor in several films.",
    "I represented the West Coast and Death Row Records.",
    "I became a central figure in the East Coast versus West Coast rivalry.",
    "I was tragically shot and killed in Las Vegas in 1996.",
    "My hits include 'California Love' and 'Dear Mama,' and my nickname was 2Pac."
  ]},
  { a:"The Notorious B.I.G.", init:"T.N.B.", clues:[
    "I am a real person.",
    "I rose to fame in the 1990s.",
    "I am an American rapper.",
    "I was famous for a smooth, heavyset flow.",
    "I came from Brooklyn, New York.",
    "I represented the East Coast against the West Coast.",
    "I was shot and killed in Los Angeles in 1997.",
    "My albums were 'Ready to Die' and 'Life After Death,' and I went by Biggie Smalls."
  ]},
  { a:"Nas", init:"N.", clues:[
    "I am a real, living person.",
    "I am an American rapper.",
    "I am celebrated as one of the greatest lyricists ever.",
    "I come from the Queensbridge projects in New York.",
    "I won a Grammy decades into my career for the album 'King's Disease.'",
    "I had a famous feud with Jay-Z that produced the diss track 'Ether.'",
    "My debut album is often called one of the best rap records of all time.",
    "That legendary 1994 debut album was titled 'Illmatic.'"
  ]},
  { a:"50 Cent", init:"5.C.", clues:[
    "I am a real, living person.",
  ...
  { a:"Dr. Dre", init:"D.D.", clues:[
    "I am a real, living person.",
    "I am an American hip-hop figure.",
    "I am best known as a producer rather than just a rapper.",
    "I helped pioneer the G-funk sound of West Coast rap.",
    "I was a member of the group N.W.A.",
    "I co-founded a headphone brand sold to Apple for billions.",
    "I discovered and mentored Eminem, 50 Cent, and Kendrick Lamar.",
    "My solo albums are titled 'The Chronic' and '2001.'"
  ]},
  { a:"Ice Cube", init:"I.C.", clues:[
    "I am a real, living person.",
  ...
  { a:"Cardi B", init:"C.B.", clues:[
    ...
    "That collaboration was the explicit smash 'WAP.'"
  ]},
  { a:"Megan Thee Stallion", init:"M.T.S.", clues:[
    "I am a real, living person.",
  ...
  { a:"J. Cole", init:"J.C.", clues:[
    "I am a real, living person.",
    "I am an American rapper and producer.",
    "I grew up in Fayetteville, North Carolina.",
    "I am known for introspective, lyrical albums.",
    "I was the first artist signed to Jay-Z's Roc Nation.",
    "One of my albums famously went 'platinum with no features.'",
    "My initials and a college name make up my stage name.",
    "That album was '2014 Forest Hills Drive.'"
  ]},
  { a:"Kid Cudi", init:"K.C.", clues:[
    ...
    "My breakout hit was the moody 'Day 'n' Nite.'"
  ]},
  { a:"Tyler, the Creator", init:"T.C.", clues:[
    "I am a real, living person.",
    "I am an American rapper and producer.",
  ...
  { a:"A$AP Rocky", init:"A.R.", clues:[
    "I am a real, living person.",
    "I am an American rapper from Harlem.",
  ...
  { a:"Wiz Khalifa", init:"W.K.", clues:[
    "I am a real, living person.",
    "I am an American rapper from Pittsburgh.",
    "I am known for tattoos and a laid-back style.",
  ...
  { a:"Mac Miller", init:"M.M.", clues:[
    "I am a real person, now deceased.",
    "I am an American rapper, singer, and producer from Pittsburgh.",
    "I broke out in the early 2010s with a frat-rap style.",
    "I later evolved into introspective, jazz-influenced music.",
    "I dated the pop star Ariana Grande.",
    "I tragically died of an overdose in 2018 at age 26.",
    "My stage name pairs a raincoat nickname with a common surname, and my real name is Malcolm.",
    "My final album, 'Swimming,' was released shortly before my death."
  ]},
  { a:"Ice-T", init:"I.T.", clues:[
    "I am a real, living person.",
    "I am an American rapper and actor.",
    "I am considered a pioneer of West Coast and gangsta rap.",
    "I fronted a heavy-metal band called Body Count.",
    "My controversial song 'Cop Killer' sparked national debate.",
    "My stage name is a frozen drink word with a single letter.",
    "I have starred for decades as a detective on a 'Law & Order' show.",
    "That show is 'Law & Order: Special Victims Unit.'"
  ]},
  { a:"LL Cool J", init:"L.C.J.", clues:[
    "I am a real, living person.",
    "I am an American rapper and actor.",
    "I was one of hip-hop's first solo superstars in the 1980s.",
  ...
  { a:"OutKast", init:"O.", clues:[
    "We are real people, an American rap duo.",
    "We come from Atlanta, Georgia.",
  ...
  { a:"Beastie Boys", init:"B.B.", clues:[
    "We are real people, an American rap group.",
    "We started as a punk band before turning to hip-hop.",
    "We were among the first prominent white rap acts.",
    "We came from New York City and signed to Def Jam.",
    "We were inducted into the Rock and Roll Hall of Fame.",
    "Our members were Mike D, Ad-Rock, and the late MCA.",
    "Our debut album 'Licensed to Ill' topped the charts.",
    "Our hits include '(You Gotta) Fight for Your Right (To Party!)' and 'Sabotage.'"
  ]},
  { a:"Grandmaster Flash", init:"G.F.", clues:[
    "I am a real, living person.",
    "I am an American hip-hop pioneer.",
    "I am one of the earliest and most important DJs in the genre.",
  ...
  { a:"Afrika Bambaataa", init:"A.B.", clues:[
    "I am a real person.",
    "I am an American hip-hop pioneer and DJ.",
    "I was a founding father of the culture in the South Bronx.",
    "I helped electronic and rap music fuse together.",
    "I founded the Universal Zulu Nation collective.",
    "My group was called the Soulsonic Force.",
    "My stage name comes from a 19th-century Zulu chief.",
    "My influential 1982 track was 'Planet Rock.'"
  ]},
  { a:"KRS-One", init:"K.O.", clues:[
    "I am a real, living person.",
    "I am an American rapper known as 'The Teacher.'",
    "I am celebrated for conscious, lyrical, and educational rap.",
    "I rose in the late 1980s from the Bronx.",
    "I championed the 'Stop the Violence' movement.",
    "I led the group Boogie Down Productions.",
    "My hits include 'Sound of da Police' and 'My Philosophy.'",
    "My stage name is an acronym for 'Knowledge Reigns Supreme Over Nearly Everyone.'"
  ]},
  { a:"Rakim", init:"R.", clues:[
    "I am a real, living person.",
    "I am an American rapper widely called one of the greatest of all time.",
  ...
  { a:"Big Daddy Kane", init:"B.D.K.", clues:[
    ...
    "I rose to fame in the late 1980s.",
  ...
  { a:"Pharrell Williams", init:"P.W.", clues:[
    "I am a real, living person.",
    "I am an American producer, rapper, and singer.",
    "I also front the band N.E.R.D.",
    "I am half of the production duo The Neptunes.",
    "I became the men's creative director for Louis Vuitton.",
    "I coached on the show 'The Voice' and wore a famous oversized hat.",
    "I also sang on 'Get Lucky' and 'Blurred Lines.'",
    "My solo smash 'Happy' came from the 'Despicable Me 2' soundtrack."
  ]},
  { a:"Metro Boomin", init:"M.B.", clues:[
    "I am a real, living person.",
  ...
  { a:"DMX", init:"D.", clues:[
    ...
    "My three-letter stage name was 'Dark Man X.'"
  ]},
  ...
  { a:"Roddy Ricch", init:"R.R.", clues:[
    "I am a real, living person.",
    "I am an American rapper from Compton, California.",
    "I broke out at the end of the 2010s.",
    "I am known for a melodic, sing-rap style.",
    "I featured on Mustard's hit 'Ballin'.'",
    "My stage name pairs a first name with a 'rich' spelling.",
    "My debut album was 'Please Excuse Me for Being Antisocial.'",
    "My breakout number-one single was 'The Box.'"
  ]}
);
