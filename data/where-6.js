window.GAME.where.push(
  { a:"Oregon", init:"O.", clues:[
    ...
    "Portland is my largest city and Salem is my capital."
  ]},
  { a:"Arkansas", init:"A.", clues:[
    "I am a US state.",
    "I am in the South.",
  ...
  { a:"Wisconsin", init:"W.", clues:[
    "I am a US state.",
    "I am in the upper Midwest.",
    "I border two of the Great Lakes.",
    "I lead the nation in dairy and cheese production.",
    "My fans are nicknamed cheeseheads.",
    "Milwaukee is my largest city.",
    "The Green Bay Packers play their football inside me.",
    "My capital is Madison."
  ]},
  { a:"Tennessee", init:"T.", clues:[
    "I am a US state.",
  ...
  { a:"Michigan", init:"M.", clues:[
    "I am a US state.",
    "I am in the Great Lakes region.",
    "I am made of two peninsulas separated by a strait.",
    "I touch four of the five Great Lakes.",
    "I am the heart of the American auto industry.",
    "I am shaped like a mitten.",
    "Detroit, the Motor City, is my largest city.",
  ...
  { a:"Maryland", init:"M.", clues:[
    ...
    "Annapolis is my capital."
  ]},
  { a:"Missouri", init:"M.", clues:[
    "I am a US state.",
    "I am in the Midwest, near the country's geographic center.",
  ...
  { a:"Wyoming", init:"W.", clues:[
    "I am a US state.",
    "I am in the Mountain West.",
    "I am a perfect rectangle in shape.",
    "I am the least populous state in the country.",
    "I was the first place in the world where women could vote.",
    "The jagged Grand Teton peaks rise inside me.",
    "Most of Yellowstone National Park lies within me.",
    "My capital is Cheyenne."
  ]},
  { a:"Idaho", init:"I.", clues:[
    "I am a US state.",
    "I am in the Pacific Northwest interior.",
    "I share a small border with Canada.",
    "My panhandle squeezes between Washington and Montana.",
    "I contain Hells Canyon, the deepest river gorge in North America.",
    "I am famous above all for growing potatoes.",
    "My license plates read 'Famous Potatoes.'",
    "My capital is Boise."
  ]},
  { a:"Kansas", init:"K.", clues:[
    "I am a US state.",
    "I am in the Great Plains.",
    "I sit near the very center of the contiguous states.",
    "I am famous for endless flat fields of wheat.",
    "Tornadoes sweep across me on Tornado Alley.",
    "Wichita is my largest city.",
    "Dorothy and Toto were swept away from a farm inside me.",
    "My capital is Topeka."
  ]},
  { a:"Connecticut", init:"C.", clues:[
    ...
    "My capital, Hartford, is the insurance capital of the world."
  ]},
  { a:"Oklahoma", init:"O.", clues:[
    ...
    "My capital city carries my own name."
  ]},
  { a:"Alabama", init:"A.", clues:[
    "I am a US state.",
  ...
  { a:"Nebraska", init:"N.", clues:[
    "I am a US state.",
    "I am in the Great Plains.",
    "I am one of the flattest, most agricultural states.",
    "I am the only state with a single-house legislature.",
    "Pioneers crossed me on the Oregon Trail along the Platte River.",
    "Warren Buffett lives and invests inside me.",
    "My football team is the Cornhuskers.",
    "My capital is Lincoln, and my largest city is Omaha."
  ]},
  { a:"Vermont", init:"V.", clues:[
    "I am a US state.",
    "I am in New England.",
    "I am the only New England state with no ocean coastline.",
    "I am famous for maple syrup and autumn leaves.",
    "Ben and Jerry's ice cream was founded inside me.",
    "Bernie Sanders represents me in the Senate.",
    "My Green Mountains gave me my name.",
    "My capital, Montpelier, is the smallest state capital in the nation."
  ]},
  { a:"New Mexico", init:"N.M.", clues:[
    "I am a US state.",
  ...
  { a:"South Dakota", init:"S.D.", clues:[
    "I am a US state.",
    "I am in the northern Great Plains.",
    "I sit just above my twin to the south.",
    "I am home to the rugged Badlands.",
    "My Black Hills hold the city of Deadwood.",
    "The Crazy Horse Memorial is still being carved inside me.",
    "Four presidents' faces are carved into my granite mountain.",
  ...
  { a:"South Carolina", init:"S.C.", clues:[
    "I am a US state.",
    "I am on the southeastern Atlantic coast.",
    "I sit just below my twin to the north.",
    "My Lowcountry is known for shrimp, grits, and palmetto trees.",
    "Myrtle Beach draws tourists to my shore.",
    "Charleston is my historic port city.",
    "The Civil War's first shots were fired at my Fort Sumter.",
    "My capital is Columbia."
  ]},
  { a:"West Virginia", init:"W.V.", clues:[
    "I am a US state.",
  ...
  { a:"Mississippi", init:"M.", clues:[
    "I am a US state.",
    "I am in the Deep South.",
    "I have a short coastline on the Gulf of Mexico.",
    "I am famous for cotton plantations and Southern literature.",
    "Author William Faulkner lived inside me.",
    "The blues music genre was born in my Delta region.",
    "I share my name with the great river on my western border.",
    "My capital is Jackson."
  ]},
  ...
  { a:"New Hampshire", init:"N.H.", clues:[
    "I am a US state.",
    "I am in New England.",
  ...
  { a:"Delaware", init:"D.", clues:[
    ...
    "My capital is Dover, and my largest city is Wilmington."
  ]},
  { a:"New Jersey", init:"N.J.", clues:[
    ...
    "My capital is Trenton."
  ]},
  { a:"Seattle", init:"S.", clues:[
    "I am a US city.",
    "I am in the Pacific Northwest.",
    "I sit on Puget Sound between mountains and water.",
    "I am famous for rain, coffee, and grunge music.",
    "Mount Rainier looms over my skyline.",
    "Amazon and Boeing were founded or based here.",
    "The first Starbucks opened inside me.",
    "My Space Needle is my most famous landmark."
  ]},
  { a:"Boston", init:"B.", clues:[
    "I am a US city.",
    "I am in New England.",
  ...
  { a:"Denver", init:"D.", clues:[
    "I am a US city.",
    "I am in the Mountain West.",
    "The Rocky Mountains rise on my western horizon.",
    "I am a hub for skiing and outdoor recreation.",
    "I sit at exactly one mile above sea level.",
    "My football team is the Broncos.",
    "I am nicknamed the Mile High City.",
    "I am the capital of Colorado."
  ]},
  { a:"Nashville", init:"N.", clues:[
    "I am a US city.",
    "I am in the southeastern US.",
  ...
  { a:"Atlanta", init:"A.", clues:[
    "I am a US city.",
    "I am in the southeastern US.",
    "I was burned during the Civil War and rebuilt from the ashes.",
    "I hosted the 1996 Summer Olympics.",
    "My airport is the busiest in the entire world.",
    "Dr. Martin Luther King Jr. was born here.",
    "Coca-Cola and CNN are headquartered inside me.",
    "I am the capital of Georgia."
  ]},
  { a:"Philadelphia", init:"P.", clues:[
    ...
    "The Liberty Bell rings in my history."
  ]},
  { a:"San Francisco", init:"S.F.", clues:[
    "I am a US city.",
    "I am on the California coast.",
    "I sit on a hilly peninsula beside a famous bay.",
    "The 1849 Gold Rush made me boom.",
    "Cable cars climb my steep streets.",
    "Alcatraz prison sat on an island in my bay.",
    "My orange suspension bridge is world famous.",
    "I am known for the Golden Gate."
  ]},
  ...
  { a:"Portland", init:"P.", clues:[
    "I am a US city.",
    "I am in the Pacific Northwest.",
    "I sit where two rivers meet, ringed by forests.",
    "I have more breweries than almost any city.",
    "I am famous for food trucks, coffee, and quirky culture.",
    "Mount Hood rises on my eastern horizon.",
    "My slogan jokingly says to 'Keep me Weird.'",
    "I am the largest city in Oregon."
  ]},
  { a:"Phoenix", init:"P.", clues:[
    "I am a US city.",
    "I am in the Southwest desert.",
    "I am one of the hottest major cities in America.",
    "Saguaro cacti grow around my edges.",
    "I am one of the fastest-growing big cities in the country.",
    "Snowbirds flock to me each winter to escape the cold.",
    "I sit in the Valley of the Sun.",
    "I am the capital of Arizona."
  ]},
  { a:"Austin", init:"A.", clues:[
    "I am a US city.",
    "I am in the south-central US.",
  ...
  { a:"Honolulu", init:"H.", clues:[
    "I am a US city.",
    "I am on an island in the middle of the Pacific Ocean.",
    "I am the most remote major city in the country.",
    "Waikiki Beach draws surfers to my shore.",
    "Diamond Head crater rises beside me.",
    "I sit on the island of Oahu.",
    "Pearl Harbor was attacked just outside me in 1941.",
    "I am the capital of Hawaii."
  ]},
  ...
  { a:"Memphis", init:"M.", clues:[
    "I am a US city.",
    "I am in the southeastern US.",
    "I sit on a bluff above the Mississippi River.",
    "I am famous for my slow-smoked barbecue.",
    "I am the birthplace of rock and roll and home of the blues.",
    "Beale Street is my famous music corridor.",
    "Dr. King was assassinated at my Lorraine Motel.",
    "Elvis Presley's Graceland mansion sits inside me."
  ]},
  { a:"Pittsburgh", init:"P.", clues:[
    "I am a US city.",
    "I am in the mid-Atlantic Appalachian region.",
    "I sit where three rivers meet.",
  ...
  { a:"Salt Lake City", init:"S.L.C.", clues:[
    "I am a US city.",
    "I am in the Mountain West.",
    "The Wasatch Mountains tower over me.",
    "I hosted the 2002 Winter Olympics.",
    "Mormon pioneers founded me in 1847.",
    "I am the headquarters of the LDS Church.",
    "I sit beside a vast mineral-rich inland sea that gives me my name.",
    "I am the capital of Utah."
  ]}
);
