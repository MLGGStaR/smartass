window.GAME.what.push(
  ...
  { a:"Pelican", init:"P.", clues:[
    "I am an animal.",
    "I am a bird that lives near water.",
    "I am a strong swimmer and graceful flier.",
    "I often glide low over the surface of the sea.",
    "I catch fish to eat.",
    "I scoop up fish and water, then drain the water out.",
    "I have a very large throat pouch under my long bill.",
    "My huge expandable beak pouch makes me unmistakable."
  ]},
  { a:"Woodpecker", init:"W.", clues:[
    ...
    "I drum a loud rat-a-tat by hammering my beak into wood."
  ]},
  ...
  { a:"Swordfish", init:"S.", clues:[
    "I am an animal.",
    "I am a fish.",
    "I live in warm ocean waters.",
    "I am a fast and powerful predatory swimmer.",
    "I am prized by sport fishermen.",
    "I am served grilled as a meaty steak.",
    "I use my long bill to slash at schools of prey.",
    "My upper jaw extends into a long flat blade like a weapon."
  ]},
  ...
  { a:"Anglerfish", init:"A.", clues:[
    "I am an animal.",
    "I am a fish.",
    "I live in the deep, dark ocean.",
    "I am one of the strangest-looking creatures in the sea.",
    "I have a huge mouth full of needle-like teeth.",
    "I lure prey close before swallowing them whole.",
    "I appeared as a scary fish in 'Finding Nemo'.",
    "A glowing lure dangles from a rod on my head."
  ]},
  { a:"Lobster", init:"L.", clues:[
    "I am an animal.",
    "I am a sea creature.",
  ...
  { a:"Squid", init:"S.", clues:[
    "I am an animal.",
    "I am a sea creature.",
    "I am a fast-moving relative of the octopus.",
    "I jet through the water by squirting water from my body.",
    "I have eight arms plus two longer tentacles.",
    "I shoot a cloud of ink to escape predators.",
    "Giant versions of me battle sperm whales in the deep.",
    "I am served battered and fried as calamari."
  ]},
  { a:"Crab", init:"C.", clues:[
    "I am an animal.",
    "I am a sea creature.",
  ...
  { a:"Walrus", init:"W.", clues:[
    "I am an animal.",
    "I am a large sea mammal.",
    "I live in the cold Arctic seas.",
    "I haul my heavy body out onto the ice to rest.",
    "I have whiskers and a thick blubbery body.",
    "The Beatles sang 'I am the' me.",
    "I use my long teeth to pull myself onto the ice.",
    "My two long ivory tusks hang from my upper jaw."
  ]},
  { a:"Sea Otter", init:"S.O.", clues:[
    "I am an animal.",
  ...
  { a:"Gecko", init:"G.", clues:[
    "I am an animal.",
    "I am a reptile.",
    "I am a small lizard.",
    "I am often active at night.",
    "Some of my kind chirp and make sounds.",
    "I can shed my tail to escape a predator.",
    "I am the mascot of a famous insurance company.",
    "Sticky toe pads let me walk up walls and across ceilings."
  ]},
  { a:"Iguana", init:"I.", clues:[
    "I am an animal.",
    "I am a reptile.",
    "I am a large lizard.",
    "I love to bask in the sun.",
    "I am mostly a plant-eater.",
    "I am often kept as an exotic pet.",
    "A spiny crest runs down my back, and a flap hangs at my throat.",
    "I am bright green and live in tropical Central and South America."
  ]},
  { a:"Tortoise", init:"T.", clues:[
    "I am an animal.",
    "I am a reptile.",
    "I move very slowly on land.",
    "I can live for over a hundred years.",
    "I am a land-dwelling cousin of the turtle.",
    "I can pull my head and legs inside for protection.",
    "I carry a hard dome on my back.",
    "In a famous fable, I beat the hare in a race."
  ]},
  { a:"Cobra", init:"C.", clues:[
    "I am an animal.",
    "I am a reptile.",
    "I am a snake.",
    "I am venomous.",
    "I rear up tall when I feel threatened.",
    "The king version of me is the longest venomous snake.",
    "Snake charmers sway baskets to make me dance.",
    "I spread a wide hood behind my head as a warning."
  ]},
  { a:"Python", init:"P.", clues:[
    "I am an animal.",
    "I am a reptile.",
    "I am a snake.",
    "I have no venom.",
  ...
  { a:"Ladybug", init:"L.", clues:[
    "I am an animal.",
    "I am an insect.",
    "I am very small and can fly.",
    "I am a welcome guest in gardens.",
    "I eat aphids that damage plants.",
    "Many cultures say I bring good luck.",
    "I am round and dome-shaped with a bright red shell.",
    "Black spots decorate my red back."
  ]},
  { a:"Grasshopper", init:"G.", clues:[
    "I am an animal.",
    "I am an insect.",
    "I live in fields and meadows.",
    "I am usually green or brown.",
    "I make a chirping sound on warm days.",
    "In a famous fable I play while the ant works.",
    "Swarms of my locust cousins can devour entire crops.",
    "My powerful back legs let me leap huge distances."
  ]},
  { a:"Dragonfly", init:"D.", clues:[
    "I am an animal.",
    "I am an insect.",
  ...
  { a:"Ant", init:"A.", clues:[
    "I am an animal.",
    "I am an insect.",
    "I am very small but very strong.",
    "I can carry many times my own body weight.",
    "I follow scent trails left by my fellows.",
    "I build hills and tunnels underground.",
    "I live in a colony with a queen.",
    "I march in long lines and invade picnics."
  ]},
  { a:"Bee", init:"B.", clues:[
    "I am an animal.",
  ...
  { a:"Cricket", init:"C.", clues:[
    ...
    "I am most often heard at night.",
    "People sometimes keep me in a cage for good luck.",
    "A famous one of me is Pinocchio's conscience.",
    "I rub my wings together to make my song.",
    "My nighttime chirping is a classic sound of summer."
  ]},
  { a:"Beetle", init:"B.", clues:[
    "I am an animal.",
    "I am an insect.",
  ...
  { a:"Moth", init:"M.", clues:[
    "I am an animal.",
    "I am an insect with wings.",
    "I am mostly active at night.",
    "I start life as a caterpillar.",
    "I rest with my wings spread flat.",
    "My antennae are feathery rather than clubbed.",
    "I am the duller, nocturnal cousin of the butterfly.",
    "I am often drawn helplessly toward porch lights."
  ]},
  { a:"Scorpion", init:"S.", clues:[
    "I am an animal.",
    "I am a small creature with eight legs.",
    "I am related to spiders.",
    "I live in deserts and warm places.",
    "I hide under rocks during the heat of the day.",
    "I glow under ultraviolet light.",
    "I have two grabbing pincers in front.",
    "A venomous stinger curls over my back on my tail."
  ]},
  ...
  { a:"Manta Ray", init:"M.R.", clues:[
    "I am an animal.",
    "I am a sea creature.",
    "I am one of the largest fish in the ocean.",
    "I am a gentle giant that eats tiny plankton.",
    "I have a flat, diamond-shaped body.",
    "I seem to fly through the water by flapping my fins like wings.",
    "Two fins near my mouth look like little horns.",
    "I am a huge, harmless cousin of the stinging flat fish with a barbed tail."
  ]},
  ...
  { a:"Crayfish", init:"C.", clues:[
    "I am an animal.",
    "I am a freshwater creature.",
  ...
  { a:"Mantis Shrimp", init:"M.S.", clues:[
    ...
    "I am famous for my dazzling rainbow colors.",
    "I have some of the most complex eyes in the animal kingdom.",
    "I can see colors no human eye can detect.",
    "My punch is so fast it boils the water around it.",
    "My club-like front limbs strike faster than a bullet."
  ]}
);
