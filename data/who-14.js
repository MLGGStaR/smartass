window.GAME.who.push(
  ...
  { a:"LeBron James", init:"L.J.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I am from Akron, Ohio.",
    "I went straight from high school to the pros.",
    "I won championships with Miami, Cleveland, and the Lakers.",
    "I am the all-time leading scorer in my league.",
    "My nickname is 'King'."
  ]},
  { a:"Muhammad Ali", init:"M.A.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I competed in a combat sport with gloves and a ring.",
    "I was a heavyweight world champion.",
    "I won an Olympic gold under my birth name, Cassius Clay.",
    "I fought in the 'Rumble in the Jungle' and 'Thrilla in Manila'.",
    "I famously said I 'float like a butterfly, sting like a bee'.",
    "I called myself 'The Greatest'."
  ]},
  { a:"Tiger Woods", init:"T.W.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
  ...
  { a:"Rafael Nadal", init:"R.N.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a racket and a net.",
    "I am from Spain.",
    "I am from the island of Mallorca.",
    "I am famous for my powerful left-handed topspin.",
    "I have won the French Open a record number of times.",
    "I am nicknamed 'The King of Clay'."
  ]},
  { a:"Pele", init:"P.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from Brazil.",
    "I later played in the United States for the New York Cosmos.",
    "I scored over a thousand career goals.",
    "I won three World Cups for my country.",
    "Many consider me 'The King' of football."
  ]},
  { a:"Diego Maradona", init:"D.M.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from Argentina.",
    "I became a legend at the Italian club Napoli.",
    "I led my country to win the 1986 World Cup.",
    "I scored the 'Goal of the Century' against England.",
    "I also scored the controversial 'Hand of God' goal."
  ]},
  { a:"Kobe Bryant", init:"K.B.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
  ...
  { a:"Serena's sister Venus Williams", init:"V.W.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a racket and a net.",
  ...
  { a:"Simone Biles", init:"S.B.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport involves flips, beams, and vaults.",
    "I am from the United States.",
  ...
  { a:"Wayne Gretzky", init:"W.G.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport is played on ice with sticks and a puck.",
    "I am from Canada.",
    "I starred for the Edmonton Oilers and Los Angeles Kings.",
    "I am the all-time leading scorer in my league.",
    "My jersey number 99 was retired across the whole league.",
    "My nickname is 'The Great One'."
  ]},
  { a:"Babe Ruth", init:"B.R.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a bat, a diamond, and bases.",
    "I am from the United States.",
    "I starred in the early 20th century.",
    "I became a legend with the New York Yankees.",
    "I set a home run record that stood for decades.",
    "My nickname is 'The Bambino' or 'The Sultan of Swat'."
  ]},
  { a:"Mike Tyson", init:"M.T.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I competed in a combat sport with gloves and a ring.",
    "I am from the United States.",
    "I was famous for knocking opponents out very quickly.",
    "I became the youngest heavyweight world champion ever.",
    "I once bit an opponent's ear in a fight.",
    "My nickname is 'Iron'."
  ]},
  { a:"Floyd Mayweather", init:"F.M.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I competed in a combat sport with gloves and a ring.",
    "I am from the United States.",
    "I was known for my defensive boxing style.",
    "I was one of the highest-paid athletes in the world.",
    "I retired undefeated with a 50-0 record.",
    "My nickname is 'Money'."
  ]},
  { a:"Stephen Curry", init:"S.C.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I am from the United States.",
    "I won multiple titles with the Golden State Warriors.",
    "I revolutionized my sport with long-range shooting.",
    "I hold the record for most three-pointers made.",
    "My nickname is 'Chef' for cooking up threes."
  ]},
  { a:"Shaquille O'Neal", init:"S.O.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I am a giant standing over seven feet tall.",
    "I was famous for dominant, backboard-shattering dunks.",
    "I later became a popular TV studio analyst.",
    "I won three straight titles with the Lakers alongside Kobe.",
    "My nickname is 'Shaq' or 'The Diesel'."
  ]},
  { a:"Magic Johnson", init:"M.J.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I am from the United States.",
    "I was a rare tall player who played point guard.",
    "My rivalry with Larry Bird defined an era.",
    "I won five titles with the Los Angeles Lakers in the 1980s.",
    "My first name is a word for stage illusions."
  ]},
  { a:"Larry Bird", init:"L.B.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I am from the United States.",
  ...
  { a:"Kylian Mbappe", init:"K.M.", clues:[
    ...
    "I play a sport with a ball and goals using my feet.",
    "I am from France.",
    "I am famous for my blistering sprinting speed.",
    "I won the World Cup as a teenager in 2018.",
    "I scored a hat-trick in the 2022 World Cup final.",
    "I starred for Paris Saint-Germain before joining Real Madrid."
  ]},
  { a:"Zinedine Zidane", init:"Z.Z.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from France.",
    "I later became a successful coach of Real Madrid.",
    "I led France to win the 1998 World Cup.",
    "I famously headbutted an opponent in the 2006 final.",
    "My elegant turn move is named after me."
  ]},
  { a:"David Beckham", init:"D.B.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from England.",
    "I played for Manchester United and Real Madrid.",
    "I was famous for my curling free kicks.",
    "I married a member of the Spice Girls.",
    "A movie about wanting to play like me used my name in its title."
  ]},
  { a:"Novak Djokovic", init:"N.D.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a racket and a net.",
    "I am from Serbia.",
    "My famous rivals are Federer and Nadal.",
    "I have spent the most weeks ranked world number one.",
    "I hold the record for the most Grand Slam singles titles in men's tennis.",
    "My nickname is 'Nole' or 'The Djoker'."
  ]},
  { a:"Maria Sharapova", init:"M.S.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a racket and a net.",
    "I am from Russia.",
  ...
  { a:"Conor McGregor", init:"C.M.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I compete in a cage in mixed martial arts.",
    "I am from Ireland.",
    "I am famous for my trash talk and left hand.",
    "I held two UFC titles in different weight classes at once.",
    "I crossed over to box Floyd Mayweather.",
    "My nickname is 'The Notorious'."
  ]},
  { a:"Ronaldinho", init:"R.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from Brazil.",
    "I won the World Cup in 2002.",
    "I starred for Barcelona and AC Milan.",
    "I was famous for my creative tricks and constant smile.",
    "My name means 'little Ronaldo' in Portuguese."
  ]},
  { a:"Sachin Tendulkar", init:"S.T.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport uses a bat, a pitch, and wickets.",
    "I am from India.",
    "I played for over 24 years for my national team.",
    "I am one of the greatest batsmen ever.",
    "I scored 100 international centuries.",
    "My nickname is the 'Little Master'."
  ]},
  { a:"Mo Salah", init:"M.S.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a sport with a ball and goals using my feet.",
    "I am from Egypt.",
  ...
  { a:"Kevin Durant", init:"K.D.", clues:[
    ...
    "I play a team sport with a ball and a hoop.",
    "I am from the United States.",
    "I am a tall scorer with a smooth jump shot.",
    "I have played for Oklahoma City, Brooklyn, and Phoenix.",
    "I won two titles with the Golden State Warriors.",
    "My nickname is 'KD' or the 'Slim Reaper'."
  ]},
  { a:"Giannis Antetokounmpo", init:"G.A.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "I play a team sport with a ball and a hoop.",
    "I was born in Greece to Nigerian parents.",
    "My long limbs help me cover the court in a few strides.",
    "I won back-to-back Most Valuable Player awards.",
    "I led the Milwaukee Bucks to a championship.",
    "My nickname is the 'Greek Freak'."
  ]},
  { a:"Katie Ledecky", init:"K.L.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport takes place in a pool.",
    "I am from the United States.",
    "I won my first Olympic gold at age 15.",
    "I dominate the longer freestyle distance races.",
    "I have won many Olympic gold medals.",
    "I hold world records in the 800m and 1500m freestyle."
  ]},
  { a:"Nadia Comaneci", init:"N.C.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport involves flips, beams, and vaults.",
    "I am from Romania.",
  ...
  { a:"Ayrton Senna", init:"A.S.", clues:[
    ...
    "My sport involves driving very fast cars.",
    "I am from Brazil.",
    "I was famous for my brilliance in rainy conditions.",
    "My rivalry with Alain Prost was intense.",
    "I won three world championships in Formula 1.",
    "I tragically died in a crash at Imola in 1994."
  ]},
  { a:"Max Verstappen", init:"M.V.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport involves driving very fast cars.",
  ...
  { a:"Manny Pacquiao", init:"M.P.", clues:[
    ...
    "I also became a senator in my country.",
    "I won world titles in eight different weight divisions.",
    "I am the only boxer to do so.",
    "My nickname is 'Pac-Man'."
  ]},
  { a:"Cathy Freeman", init:"C.F.", clues:[
    "I am a real person.",
    "I am a famous athlete.",
    "My sport is track and field.",
