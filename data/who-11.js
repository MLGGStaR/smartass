window.GAME.who.push(
  ...
  { a:"Roronoa Zoro", init:"R.Z.", clues:[
    "I am a fictional character.",
    "I appear in a hit pirate manga and anime.",
  ...
  { a:"Light Yagami", init:"L.Y.", clues:[
    "I am a fictional character.",
    "I appear in a dark psychological manga and anime.",
    "I am a brilliant high school student at the top of my class.",
    "I came to believe I could create a perfect new world.",
    "I gained a supernatural power that brings death.",
    "I am followed by a bored apple-loving entity from another realm.",
    "The public calls my mysterious justice persona 'Kira'.",
    "I kill criminals by writing names in a notebook, hunted by the detective L in 'Death Note'."
  ]},
  { a:"Ryuk", init:"R.", clues:[
    "I am a fictional character.",
  ...
  { a:"Edward Elric", init:"E.E.", clues:[
    ...
    "I am a prodigy who mastered a forbidden science as a child.",
    "I am sensitive about being called short.",
    "I lost parts of my body in a tragic failed experiment.",
    "My younger brother's soul is bound to a suit of armor.",
    "I have automail metal limbs replacing what I lost.",
  ...
  { a:"Spike Spiegel", init:"S.S.", clues:[
    ...
    "My haunted history involves Julia and a rival named Vicious aboard the Bebop in 'Cowboy Bebop'."
  ]},
  { a:"Vegeta", init:"V.", clues:[
    "I am a fictional character.",
    "I appear in a legendary action manga and anime.",
    "I am the proud prince of a nearly extinct warrior race.",
    "I began as a ruthless villain before becoming a reluctant ally.",
    "I am obsessed with surpassing the series' cheerful hero.",
    "I can power up into golden-haired transformations.",
    "My signature attack is the Galick Gun.",
    "My Saiyan homeworld was destroyed by Frieza, and I am the rival of Goku in 'Dragon Ball'."
  ]},
  ...
  { a:"Asta", init:"A.", clues:[
    "I am a fictional character.",
    "I appear in a magic-filled manga and anime.",
    "I grew up as an orphan in a poor church.",
    "I live in a world where everyone wields magic but me.",
    "I am loud, energetic, and never give up on my dream.",
    "I dream of becoming the leader of all the wizards.",
    "I swing enormous swords that cancel out magic.",
    "My grimoire is a rare five-leaf clover holding a devil, and I want to be the Wizard King in 'Black Clover'."
  ]},
  { a:"Yusuke Urameshi", init:"Y.U.", clues:[
    "I am a fictional character.",
    "I appear in a classic supernatural manga and anime.",
    "I started out as a delinquent teenager and a troublemaker.",
    "I died saving a child and then earned a second chance.",
    "I was brought back to serve a special role.",
    "I investigate cases involving demons and the afterlife.",
    "I fire a glowing blast of energy from my finger.",
  ...
  { a:"Sailor Moon", init:"S.M.", clues:[
    "I am a fictional character.",
    "I appear in an iconic magical-girl manga and anime.",
  ...
  { a:"Lelouch Lamperouge", init:"L.L.", clues:[
    "I am a fictional character.",
    "I appear in a strategic sci-fi anime.",
    "I am a brilliant, calculating exiled prince.",
    "I attend an ordinary school while plotting in secret.",
    "I gained a mysterious power from a green-haired girl.",
    "My power forces anyone to obey a single command.",
    "I lead a rebellion against a vast empire from behind a mask.",
    "My masked alter ego is Zero, my power is Geass, and I pilot Knightmare Frames in 'Code Geass'."
  ]},
  { a:"Hinata Hyuga", init:"H.H.", clues:[
    "I am a fictional character.",
    "I appear in a famous ninja manga and anime.",
    "I come from a noble clan with a special bloodline.",
    "I was shy and lacked confidence in my youth.",
    "I have long dark hair and pale lavender eyes.",
    "My clan's eyes can see through objects and chakra points.",
    "My signature eyes are called the Byakugan.",
    "I had a long crush on the orange-clad hero and eventually marry Naruto in 'Naruto'."
  ]},
  { a:"Guts", init:"G.", clues:[
    "I am a fictional character.",
    "I appear in a dark, brutal manga and anime.",
    "I am a lone mercenary with a tragic, violent past.",
    "I am marked with a brand that draws evil spirits to me.",
    "I lost an eye and an arm in a terrible betrayal.",
    "My missing arm is replaced with an iron prosthetic and a hidden cannon.",
    "I hunt demons across a grim medieval-style world.",
    "I swing the massive sword called the Dragon Slayer as the Black Swordsman of 'Berserk'."
  ]},
  ...
  { a:"Roy Mustang", init:"R.M.", clues:[
    "I am a fictional character.",
    "I appear in a popular alchemy manga and anime.",
    "I am an ambitious military officer with big plans.",
    "I am charming, confident, and a bit of a flirt.",
    "I dream of rising to the very top of my nation's command.",
    "I wear special gloves marked with an array.",
    "I can snap my fingers to create bursts of fire.",
  ...
  { a:"Thorfinn", init:"T.", clues:[
    ...
    "I am a young Viking on a long quest for vengeance and meaning, the hero of 'Vinland Saga'."
  ]},
  { a:"Senku Ishigami", init:"S.I.", clues:[
    "I am a fictional character.",
    "I appear in a science-themed manga and anime.",
  ...
  { a:"Denji", init:"D.", clues:[
    "I am a fictional character.",
    "I appear in a violent modern manga and anime.",
    "I grew up dirt poor, burdened by my dead father's debt.",
    "My only friend was a small chainsaw-nosed pet devil.",
    "I was betrayed and killed, then fused with my pet to survive.",
    "I can pull cords on my body to transform.",
    "Blades sprout from my arms and head when I change.",
    "I am a devil hunter for a public safety agency, the title character of 'Chainsaw Man'."
  ]},
  { a:"Yuno", init:"Y.", clues:[
    "I am a fictional character.",
    "I appear in a magic-filled manga and anime.",
    "I grew up as an orphan beside a loud, magicless rival.",
    "I am calm, gifted, and naturally talented at magic.",
    "I received a rare four-leaf clover grimoire.",
    "Later a wind spirit becomes my partner.",
    "I joined the elite Golden Dawn squad.",
    "I wield powerful wind magic and compete to become the Wizard King in 'Black Clover'."
  ]},
  ...
  { a:"Tohru Honda", init:"T.H.", clues:[
    "I am a fictional character.",
    "I appear in a gentle romance manga and anime.",
    "I am a kind and selfless high school girl.",
    "I lost my mother and was living in a tent for a time.",
    "I came to live with a peculiar, secretive family.",
    "I discovered that family's members hold a strange curse.",
    "They transform into zodiac animals when hugged by the opposite sex.",
    "I try to break the Sohma family's curse with my warmth, the heroine of 'Fruits Basket'."
  ]},
  ...
  { a:"Saber", init:"S.", clues:[
    "I am a fictional character.",
    "I appear in a fantasy manga and anime franchise.",
    "I am a heroic spirit summoned to fight in a deadly tournament.",
    "I battle for the right to claim a wish-granting relic.",
    "I appear as a graceful blonde knight in armor.",
    "My true identity is a legendary king of Britain.",
    "I wield a golden holy sword cloaked in invisible wind.",
    "That blade is Excalibur; I pulled the sword from the stone as the King of Knights in the 'Fate' series."
  ]},
  { a:"Yato", init:"Y.", clues:[
    "I am a fictional character.",
