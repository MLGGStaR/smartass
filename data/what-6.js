window.GAME.what.push(
  ...
  { a:"Backpack", init:"B.", clues:[
    ...
    "I ride on your back so your hands stay free.",
    "Students stuff me full of books to carry to school."
  ]},
  { a:"Iron", init:"I.", clues:[
    "I am an object.",
    "I am a household appliance.",
    "I plug into the wall for electricity.",
    "I have a handle on top you grip.",
    "My flat metal bottom plate gets very hot.",
    "I puff out steam through tiny holes.",
    "You glide me back and forth over fabric on a board.",
    "I press the wrinkles out of a shirt."
  ]},
  { a:"Blender", init:"B.", clues:[
    ...
    "I turn fruit, ice, and liquid into a smooth drink.",
    "You press my button to whip up a smoothie or a milkshake."
  ]},
  ...
  { a:"Sofa", init:"S.", clues:[
    ...
    "I am long, soft, and upholstered.",
    "I have armrests on each end and cushions on top.",
    "Several people can sit on me at once.",
    "People flop onto me to watch television.",
    "I am also called a couch or a settee."
  ]},
  { a:"Dresser", init:"D.", clues:[
    ...
    "I store your folded clothes like socks and shirts."
  ]},
  { a:"Bookshelf", init:"B.", clues:[
    "I am an object.",
    "I am a piece of furniture.",
    "I am usually made of wood or metal.",
  ...
  { a:"Calculator", init:"C.", clues:[
    "I am an object.",
    "I am a small electronic device.",
    "I fit in your hand or your pocket.",
    "I run on batteries or a tiny solar panel.",
    "My little screen shows the answer.",
    "I have a grid of buttons with numbers on them.",
    "I also have keys for plus, minus, and equals.",
    "Students use me in math class to add and multiply quickly."
  ]},
  { a:"Stove", init:"S.", clues:[
    "I am an object.",
  ...
  { a:"Glue", init:"G.", clues:[
    "I am an object.",
    "I am a school and craft supply.",
  ...
  { a:"Ruler", init:"R.", clues:[
    ...
    "I measure length in inches and centimeters."
  ]},
  { a:"Highlighter", init:"H.", clues:[
    "I am an object.",
    "I am a writing tool.",
    "I am a type of marker.",
    "I have a chisel-shaped felt tip.",
    "My ink is bright and see-through.",
    "I come in neon yellow, pink, and green.",
    "I draw a transparent stripe over words without hiding them.",
    "Students use me to mark the important parts of a textbook."
  ]},
  ...
  { a:"Mug", init:"M.", clues:[
    ...
    "I keep your drink warm.",
    "People fill me with coffee, tea, or hot chocolate."
  ]},
  { a:"Fork", init:"F.", clues:[
    "I am an object.",
    "I am a piece of cutlery.",
  ...
  { a:"Plate", init:"P.", clues:[
    ...
    "You pile your meal on top of me to eat it."
  ]},
  { a:"Bucket", init:"B.", clues:[
    "I am an object.",
    "I am a container.",
    "I am made of metal or plastic.",
  ...
  { a:"Razor", init:"R.", clues:[
    "I am an object.",
    "I am a grooming tool.",
    "I am small and held in one hand.",
    "I have a handle and a head at the top.",
    "My head holds one or more very sharp blades.",
    "You glide me over wet, soapy skin.",
    "I cut hair right at the surface of the skin.",
    "People use me to shave their face or legs."
  ]},
  { a:"Sponge", init:"S.", clues:[
    ...
    "You scrub dirty dishes at the kitchen sink with me."
  ]},
  { a:"Flashlight", init:"F.", clues:[
    "I am an object.",
    "I am a handheld device.",
  ...
  { a:"Notebook", init:"N.", clues:[
    "I am an object.",
    "I am a school supply.",
    "I am made of many sheets of paper.",
    "My pages are bound together along one edge.",
    "I often have a spiral wire or glued spine.",
    "My pages are usually printed with lines.",
    "You fill me up by writing with a pen or pencil.",
    "Students take class notes inside me."
  ]},
  { a:"Envelope", init:"E.", clues:[
    "I am an object.",
    "I am made of paper.",
    "I am a flat, thin pocket.",
    "I have a flap that folds over and seals shut.",
    "You lick or peel my flap to close me.",
    "An address gets written across my front.",
    "A stamp goes in my corner before I travel.",
    "I carry a letter through the mail."
  ]},
  { a:"Stamp", init:"S.", clues:[
    "I am an object.",
    "I am a tiny piece of paper.",
  ...
  { a:"Key", init:"K.", clues:[
    "I am an object.",
    "I am a small metal tool.",
    "I fit in your pocket or on a ring.",
    "One end of me is a round bow you grip.",
    "The other end is a thin blade with notches cut into it.",
    "Those notches match a specific pattern.",
    "You insert me and turn me in a lock.",
    "I open your front door or start your car."
  ]},
  { a:"Pillowcase", init:"P.", clues:[
    "I am an object.",
    "I am made of soft fabric like cotton.",
    "I am a flat cloth pocket, open at one end.",
    "I belong on a bed.",
    "I come as part of a matching sheet set.",
    "I get changed and washed on laundry day.",
    "You slide something soft and squishy inside me.",
    "I am the removable cover that slips over a pillow."
  ]},
  { a:"Trash Can", init:"T.C.", clues:[
    "I am an object.",
    "I am a container.",
    "I am made of metal or plastic.",
  ...
  { a:"Mop", init:"M.", clues:[
    "I am an object.",
    "I am a cleaning tool.",
    "I have a very long handle.",
    "At my bottom is a bundle of thick, absorbent strands.",
    "You dip me in a bucket of soapy water.",
    "Then you wring me out and push me across the floor.",
    "I am often paired with a broom for cleaning a kitchen.",
    "I soak up spills and wash hard floors."
  ]},
